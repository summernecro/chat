...
import com.summer.chat.util.MediaUtil;
...
public class VoiceMessage extends Message {
    ...
    public void showMessage(ChatAdapter.ViewHolder viewHolder, Context context) {
        ...
        LinearLayout linearLayout = new LinearLayout(ChatApp.getContext());
        linearLayout.setOrientation(LinearLayout.HORIZONTAL);
        linearLayout.setGravity(Gravity.CENTER);
        ImageView voiceIcon = new ImageView(ChatApp.getContext());
        ...
        TextView tv = new TextView(ChatApp.getContext());
        tv.setTextSize(TypedValue.COMPLEX_UNIT_SP, 18);
        tv.setTextColor(ChatApp.getContext().getResources().getColor(isSelf() ? R.color.white : R.color.black));
    ...
    public String getSummary() {
        ...
        return ChatApp.getContext().getString(R.string.summary_voice);
    }
