package com.summer.chat.chat.userinfo;
...
public class UserInfoAct extends BaseUIActivity<UserInfoUIOpe,UserInfoDAOpe,UserInfoValue> implements View.OnClickListener{

    public static void goTo(Context context, RegistB registB){
        Intent i = new Intent(context,UserInfoAct.class);
